window.alert("Você está no meu projeto de Amazon Video");
...
fetch('https://api.themoviedb.org/3/person/{person_id}?api_key=506fadb0256c13349acc05dabebf9604&language=en-US')
.then(response=> response.json())
.then(data=>{
